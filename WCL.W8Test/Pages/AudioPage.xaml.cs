...
using WindowsCommonLibrary.WindowsStore.Common;

// The Basic Page item template is documented at http://go.microsoft.com/fwlink/?LinkId=234237

namespace WCL.W8Test.Pages
{
    /// <summary>
    ...
    public sealed partial class AudioPage : Page
    {
        ...
        {
            var _fileSavePicker = new FileSavePicker();
            _fileSavePicker.FileTypeChoices.Add("Encoding", new List<string>() { ".mp2", ".wma" });
            ...
            var _audioStream = await audioService.GetAudioAsync();

            byte[] buffer = new byte[_audioStream.Length];
            int result = _audioStream.Read(buffer, 0, (int)_audioStream.Length);
